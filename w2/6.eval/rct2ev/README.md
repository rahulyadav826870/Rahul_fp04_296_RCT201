...
- Create the following APP: [Products Routes WebApp](https://rct-201-c2-liart.vercel.app) using the Provided Boilerplate.
...
1. Downlaod as ZIP from [https://github.com/masai-problems/rct-201-c2-boiler.git](https://github.com/masai-problems/rct-201-c2-boiler.git) inside your masai-repo
2. unzip.
3. navigate to the folder `cd rct-201-c2`
4. npm install
5. npm start
